...
function ReserveMenu() {
  ...
  const plusReserveList = (e) => {
    ...
    //기존에 담은 상품이 있는 경우
      ...
      //다른 상품을 추가하는 경우
      if(different){
        allItemList.push({itemId: targetId,itemNum: 1, itemPrice: targetPrice})
      }
              ...
              <div className="menu-card">
                ...
                <div className="menu-info">
                  ...
                  <div className="menu-name">
                    <img id={thisMenu.id} className="buttonStyle" src="/Assets/reserve/minus.png" alt="minus" onClick={minusReserveList}/>
                      {/* <GetThisItemNum target={thisMenu.id}/> */}
                      {
                        GetThisItemNum(thisMenu.id)
                      }
                    <img id={thisMenu.id} className="buttonStyle"  src="/Assets/reserve/plus.png" alt="plus" onClick={plusReserveList}/>
                  </div>
                  {/* <input */}  
                </div>
              </div>
